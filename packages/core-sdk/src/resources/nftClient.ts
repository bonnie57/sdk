...
export class NftClient {
   ...
   *   @param request.name - The name ossssf the collection.
   ...
   *   @param request.mintFeeRecipient - The contract URI for the col2222tion. Follows ERC-7572 standard. See https://eips.ethereum.org/EIPS/eip-7572
